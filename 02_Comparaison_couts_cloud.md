...
* **Taux de change appliqué :** 1.00 € = 1.05 $.
...
* **OVHcloud :**
    ...
    * **Tarif :** ~0,036 €/heure.
    * **Stockage :** Inclus (0 $).
    * **Calcul :** 3 660 h x 0,036 € x 1,05 ≈ **138,35 $**.

* **Scaleway :**
    * **Offre :** Instance Development `PLAY2-MICRO` (4 vCPU, 8 Go RAM).
    * **Tarif :** ~0,054 €/heure.
    * **Stockage :** Block Storage (Non inclus).
    * **Calcul Compute :** 3 660 h x 0,054 € x 1,05 ≈ 207,52 $.
    * **Calcul Stockage :** 120 Go x 0,08 $≈ 9,60$.
    * **Total :** 207,52 + 9,60 = **217,12 $**.

* **Azure :**
    * **Offre :** Instance **B4als v2** (4 vCPU, 8 Go RAM).
    * **Tarif :** **0,151 $/heure**.
    * **Stockage :** Disques SSD Standard 32 Go (E4) à **2,64 $/mois**.
    * **Calcul Compute :** 3 660 h x 0,151 $= 552,66$.
    * **Calcul Stockage :** 6 x 2,64 $= 15,84$.
    * **Total :** 552,66 + 15,84 = **568,50 $**.
...
* **OVHcloud :**
    * **Web (x3) :** Instance `d2-4` (Stockage inclus).
        * 3 x 730 h x 0,023 € x 1,05 ≈ 52,88 $.
    * **Load Balancer :** Offre Public Cloud (~16 €) ≈ 16,80 $.
    * **Database :** Managed SQL (Discovery 8Go) ≈ 52,12 $.
    * **Total :** **121,80 $**.

* **Scaleway :**
    * **Web (x3) :** Instance `PLAY2-NANO` + 50 Go Block Storage par serveur.
        * Compute : 3 x 730 h x 0,027 € x 1,05 ≈ 62,10 $.
        * Stockage : 150 Go x 0,08 $≈ 12,00$.
    * **Load Balancer :** Forfait ≈ 15,75 $.
    * **Database :** Managed DB (Cost optimized) ≈ 63,00 $.
    * **Total :** **152,85 $**.

* **Azure :**
    * **Web (x3) :** Instance **B2als v2** (0,043 $/h) + SSD Standard 64Go (5,28 $).
        * Compute : 3 x 730 h x 0,043 $= 94,17$.
        * Stockage : 3 x 5,28 $= 15,84$.
    * **Load Balancer :** Standard ≈ 20,00 $.
    * **Database :** MySQL Flexible Server ≈ 75,00 $.
    * **Total :** 110,01 + 20,00 + 75,00 = **205,01 $**.
